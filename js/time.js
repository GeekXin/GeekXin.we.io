function showTime() { 
	...
	var startDate = new Date(2017, 11, 19);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "凡凡 和 燮燮:<br>"
		+ "已经相爱:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >---永远爱你的燮燮&nbsp&nbsp</c>"; 
